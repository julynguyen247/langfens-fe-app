              ...
              return (
                <button
                  ...
                  className={`px-3 h-9 rounded-full border-[2px] text-sm font-medium transition-colors duration-150 ${
                    active
                      ? "bg-[var(--primary)] text-[var(--card)] border-[var(--primary)] shadow-sm"
                      : "bg-[var(--card)] text-[var(--text-body)] border-[var(--border)] hover:bg-[var(--background)] hover:border-[var(--primary)]"
                  }`}
