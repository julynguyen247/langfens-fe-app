...
export const QUESTION_SCHEMAS: Record<string, QuestionSchema> = {
  ...
  "blankAcceptTexts": {
    ...
    constraints: [
      "promptMd should contain [1], [2]… placeholders OR numbered list",
  ...
  "blankAcceptTexts": { "0": ["100", "one hundred"] }
    ...
    constraints: [
      "promptMd typically contains a markdown table with [1], [2]… cells",
  ...
  "skill": "LISTENING",
  "difficulty": 3,
  "promptMd": "Label positions [1] through [5] on the map.",
