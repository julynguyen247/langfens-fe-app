...
export const QUESTION_SCHEMAS: Record<string, QuestionSchema> = {
  ...
  "skill": "READING",
  "difficulty": 2,
  "promptMd": "Complete the summary:\\n\\nThe moon orbits the ___ every ___ days.",
  "blankAcceptTexts": {
    "0": ["earth", "Earth"],
    "1": ["27", "twenty-seven"]
  }
  ...
  "skill": "READING",
  "difficulty": 2,
  "promptMd": "1. Listening to music reduces ___ levels.\\n2. The brain's ___ manages emotion.",
  ...
  "skill": "LISTENING",
  "difficulty": 3,
  "promptMd": "Label the diagram below with ___, ___…",
  ...
  "skill": "LISTENING",
  "difficulty": 3,
  "promptMd": "Label positions ___ through ___ on the map.",
